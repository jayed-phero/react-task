                        ...
                        <div class="flex-1 flex items-center justify-end text-slate-700 dark:text-slate-100">
                            ...
                            <div class="relative">
                                <button
                                    ...
                                    class="text-opacity-90 group w-10 h-10 sm:w-12 sm:h-12 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-full inline-flex items-center justify-center focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 relative" type="button" >
                                    <div class="w-3.5 h-3.5 flex items-center justify-center bg-blue-500 absolute top-1.5 right-1.5 rounded-full text-[10px] leading-none text-white font-medium">
                                        <span class="mt-[1px]">{cartItems?.length}</span>
                                    </div>

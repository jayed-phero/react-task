...
const RegularDelivery = () => {
    ...
    useEffect(() => {
        ...
        const fetchProducts = async () => {
            try {
                const response = await fetch(`${process.env.REACT_APP_API_URL}/api/v1/shop/regular?page=${page}&size=${size}`);
    ...
    return (
        <section class="max-w-6xl px-5 mx-auto lg:px-0">
            <h2 class="text-lg font-medium text-gray-800 dark:text-white">Regular Delivery</h2>

            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">This is all Regular Delivery order from customers.</p>

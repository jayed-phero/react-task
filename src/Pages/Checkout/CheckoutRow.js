...
const CheckoutRow = ({ items, setCartItems, cartItems }) => {
    ...
    return (
        <div class="relative flex py-7 first:pt-0 last:pb-0">
            <div class="relative h-32 w-24 sm:w-28 flex-shrink-0 overflow-hidden rounded-xl bg-slate-100">
                <img
                    src={images[0]}
            ...
            <div class="ml-3 sm:ml-6 flex flex-1 flex-col">
                ...
                <div class="flex mt-auto pt-4 items-end justify-between text-sm">
                    <div class="hidden sm:block text-center relative">
                        <div class="nc-NcInputNumber flex items-center justify-between space-x-5 relative z-10">
                            <div class="nc-NcInputNumber__content flex items-center justify-between w-[104px] sm:w-28">
                                ...
                                <span class="select-none block flex-1 text-center leading-none">{items?.quantity}
                                </span>
                                <button
                    ...
                    <button
                        ...
                        href="##" class="relative z-10 flex items-center mt-3 font-medium text-primary-6000 hover:text-primary-500 text-sm ">
                        <span>Remove
                        </span>
                    </button>
                </div>
